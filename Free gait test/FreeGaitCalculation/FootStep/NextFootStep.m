...
function StepForLeg = NextFootStep(BODY_FOR_CALU, footReadytoMove, Obstacle_Point, alpha)
...
% 对map_z赋值
map_z = getFootHeight(Obstacle_Point, BODY_FOR_CALU, footReadytoMove, map_x, map_y);
