...
%         BODY_FOR_SHOW.Robot.lineAB BODY_FOR_SHOW.Robot.lineBC BODY_FOR_SHOW.Robot.lineCD BODY_FOR_SHOW.Robot.lineAD]);
    delete([BODY_FOR_SHOW.threeD.Body;BODY_FOR_SHOW.threeD.leg1;BODY_FOR_SHOW.threeD.leg2;BODY_FOR_SHOW.threeD.leg3;...
        ...
        BODY_FOR_SHOW.threeD.lineAB;BODY_FOR_SHOW.threeD.lineBC;BODY_FOR_SHOW.threeD.lineCD;BODY_FOR_SHOW.threeD.lineAD;BODY_FOR_SHOW.threeD.BODYCOG]);
...
%调试方便绘制机身坐标系原点
BODY_FOR_SHOW.threeD.BODYCOG = scatter3(BODY_FOR_MOVE.COG(5,1), BODY_FOR_MOVE.COG(5,2), BODY_FOR_MOVE.COG(5,3), 50,'r','filled'); % 重心投影点
%绘制轨迹
if Foot~=5
