...
// Common copy functions for custon_robot_msgs/msgsRequest
...
#endif //_MSC_VER
#include "ros/ros.h"
#include "custon_robot_msgs/msgs.h"
#include "visibility_control.h"
#include "ROSPubSubTemplates.hpp"
#include "ROSServiceTemplates.hpp"
class CUSTON_ROBOT_MSGS_EXPORT custon_robot_msgs_msg_msgsRequest_common : public MATLABROSMsgInterface<custon_robot_msgs::msgs::Request> {
  public:
    virtual ~custon_robot_msgs_msg_msgsRequest_common(){}
    virtual void copy_from_struct(custon_robot_msgs::msgs::Request* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const custon_robot_msgs::msgs::Request* msg, MultiLibLoader loader, size_t size = 1);
};
  void custon_robot_msgs_msg_msgsRequest_common::copy_from_struct(custon_robot_msgs::msgs::Request* msg, const matlab::data::Struct& arr,
  ...
  //----------------------------------------------------------------------------
  MDArray_T custon_robot_msgs_msg_msgsRequest_common::get_arr(MDFactory_T& factory, const custon_robot_msgs::msgs::Request* msg,
    ...
    outArray[ctr]["MessageType"] = factory.createCharArray("custon_robot_msgs/msgsRequest");
    // command_index
    ...
    outArray[ctr]["Foot1TraceX"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot1_trace_x_type::const_iterator, double>({currentElement_foot1_trace_x.size(),1}, currentElement_foot1_trace_x.begin(), currentElement_foot1_trace_x.end());
    // foot1_trace_y
    auto currentElement_foot1_trace_y = (msg + ctr)->foot1_trace_y;
    outArray[ctr]["Foot1TraceY"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot1_trace_y_type::const_iterator, double>({currentElement_foot1_trace_y.size(),1}, currentElement_foot1_trace_y.begin(), currentElement_foot1_trace_y.end());
    // foot1_trace_z
    auto currentElement_foot1_trace_z = (msg + ctr)->foot1_trace_z;
    outArray[ctr]["Foot1TraceZ"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot1_trace_z_type::const_iterator, double>({currentElement_foot1_trace_z.size(),1}, currentElement_foot1_trace_z.begin(), currentElement_foot1_trace_z.end());
    // foot2_trace_x
    auto currentElement_foot2_trace_x = (msg + ctr)->foot2_trace_x;
    outArray[ctr]["Foot2TraceX"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot2_trace_x_type::const_iterator, double>({currentElement_foot2_trace_x.size(),1}, currentElement_foot2_trace_x.begin(), currentElement_foot2_trace_x.end());
    // foot2_trace_y
    auto currentElement_foot2_trace_y = (msg + ctr)->foot2_trace_y;
    outArray[ctr]["Foot2TraceY"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot2_trace_y_type::const_iterator, double>({currentElement_foot2_trace_y.size(),1}, currentElement_foot2_trace_y.begin(), currentElement_foot2_trace_y.end());
    // foot2_trace_z
    auto currentElement_foot2_trace_z = (msg + ctr)->foot2_trace_z;
    outArray[ctr]["Foot2TraceZ"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot2_trace_z_type::const_iterator, double>({currentElement_foot2_trace_z.size(),1}, currentElement_foot2_trace_z.begin(), currentElement_foot2_trace_z.end());
    // foot3_trace_x
    auto currentElement_foot3_trace_x = (msg + ctr)->foot3_trace_x;
    outArray[ctr]["Foot3TraceX"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot3_trace_x_type::const_iterator, double>({currentElement_foot3_trace_x.size(),1}, currentElement_foot3_trace_x.begin(), currentElement_foot3_trace_x.end());
    // foot3_trace_y
    auto currentElement_foot3_trace_y = (msg + ctr)->foot3_trace_y;
    outArray[ctr]["Foot3TraceY"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot3_trace_y_type::const_iterator, double>({currentElement_foot3_trace_y.size(),1}, currentElement_foot3_trace_y.begin(), currentElement_foot3_trace_y.end());
    // foot3_trace_z
    auto currentElement_foot3_trace_z = (msg + ctr)->foot3_trace_z;
    outArray[ctr]["Foot3TraceZ"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot3_trace_z_type::const_iterator, double>({currentElement_foot3_trace_z.size(),1}, currentElement_foot3_trace_z.begin(), currentElement_foot3_trace_z.end());
    // foot4_trace_x
    auto currentElement_foot4_trace_x = (msg + ctr)->foot4_trace_x;
    outArray[ctr]["Foot4TraceX"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot4_trace_x_type::const_iterator, double>({currentElement_foot4_trace_x.size(),1}, currentElement_foot4_trace_x.begin(), currentElement_foot4_trace_x.end());
    // foot4_trace_y
    auto currentElement_foot4_trace_y = (msg + ctr)->foot4_trace_y;
    outArray[ctr]["Foot4TraceY"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot4_trace_y_type::const_iterator, double>({currentElement_foot4_trace_y.size(),1}, currentElement_foot4_trace_y.begin(), currentElement_foot4_trace_y.end());
    // foot4_trace_z
    auto currentElement_foot4_trace_z = (msg + ctr)->foot4_trace_z;
    outArray[ctr]["Foot4TraceZ"] = factory.createArray<custon_robot_msgs::msgs::Request::_foot4_trace_z_type::const_iterator, double>({currentElement_foot4_trace_z.size(),1}, currentElement_foot4_trace_z.begin(), currentElement_foot4_trace_z.end());
    }
    return std::move(outArray);
  }
class CUSTON_ROBOT_MSGS_EXPORT custon_robot_msgs_msg_msgsResponse_common : public MATLABROSMsgInterface<custon_robot_msgs::msgs::Response> {
  public:
    virtual ~custon_robot_msgs_msg_msgsResponse_common(){}
    virtual void copy_from_struct(custon_robot_msgs::msgs::Response* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const custon_robot_msgs::msgs::Response* msg, MultiLibLoader loader, size_t size = 1);
};
  void custon_robot_msgs_msg_msgsResponse_common::copy_from_struct(custon_robot_msgs::msgs::Response* msg, const matlab::data::Struct& arr,
               MultiLibLoader loader) {
    try {
        //isFinish
  ...
  //----------------------------------------------------------------------------
  MDArray_T custon_robot_msgs_msg_msgsResponse_common::get_arr(MDFactory_T& factory, const custon_robot_msgs::msgs::Response* msg,
       MultiLibLoader loader, size_t size) {
    auto outArray = factory.createStructArray({size,1},{"MessageType","IsFinish"});
    for(size_t ctr = 0; ctr < size; ctr++){
    outArray[ctr]["MessageType"] = factory.createCharArray("custon_robot_msgs/msgsResponse");
    // isFinish
...
class CUSTON_ROBOT_MSGS_EXPORT custon_robot_msgs_msgs_service : public ROSMsgElementInterfaceFactory {
  public:
    virtual ~custon_robot_msgs_msgs_service(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          custon_robot_msgs_msgs_service::generatePublisherInterface(ElementType type){
    std::shared_ptr<MATLABPublisherInterface> ptr;
    if(type == eRequest){
        ptr = std::make_shared<ROSPublisherImpl<custon_robot_msgs::msgs::Request,custon_robot_msgs_msg_msgsRequest_common>>();
    }else if(type == eResponse){
        ptr = std::make_shared<ROSPublisherImpl<custon_robot_msgs::msgs::Response,custon_robot_msgs_msg_msgsResponse_common>>();
    }else{
  ...
  std::shared_ptr<MATLABSubscriberInterface> 
          custon_robot_msgs_msgs_service::generateSubscriberInterface(ElementType type){
    std::shared_ptr<MATLABSubscriberInterface> ptr;
    if(type == eRequest){
        ptr = std::make_shared<ROSSubscriberImpl<custon_robot_msgs::msgs::Request,custon_robot_msgs::msgs::Request::ConstPtr,custon_robot_msgs_msg_msgsRequest_common>>();
    }else if(type == eResponse){
        ptr = std::make_shared<ROSSubscriberImpl<custon_robot_msgs::msgs::Response,custon_robot_msgs::msgs::Response::ConstPtr,custon_robot_msgs_msg_msgsResponse_common>>();
    }else{
        throw std::invalid_argument("Wrong input, Expected 'Request' or 'Response'");
    }
    return ptr;
  ...
  std::shared_ptr<MATLABSvcServerInterface> 
          custon_robot_msgs_msgs_service::generateSvcServerInterface(){
    return std::make_shared<ROSSvcServerImpl<custon_robot_msgs::msgs::Request,custon_robot_msgs::msgs::Response,custon_robot_msgs_msg_msgsRequest_common,custon_robot_msgs_msg_msgsResponse_common>>();
  }
  std::shared_ptr<MATLABSvcClientInterface> 
          custon_robot_msgs_msgs_service::generateSvcClientInterface(){
    return std::make_shared<ROSSvcClientImpl<custon_robot_msgs::msgs,custon_robot_msgs::msgs::Request,custon_robot_msgs::msgs::Response,custon_robot_msgs_msg_msgsRequest_common,custon_robot_msgs_msg_msgsResponse_common>>();
  }
#include "ROSbagTemplates.hpp" 
  std::shared_ptr<MATLABRosbagWriterInterface> 
          custon_robot_msgs_msgs_service::generateRosbagWriterInterface(ElementType type){
    std::shared_ptr<MATLABRosbagWriterInterface> ptr;
    if(type == eRequest){
        ptr = std::make_shared<ROSBagWriterImpl<custon_robot_msgs::msgsRequest,custon_robot_msgs_msg_msgsRequest_common>>();
    }else if(type == eResponse){
        ptr = std::make_shared<ROSBagWriterImpl<custon_robot_msgs::msgsResponse,custon_robot_msgs_msg_msgsResponse_common>>();
    }else{
        throw std::invalid_argument("Wrong input, Expected 'Request' or 'Response'");
    }
    return ptr;
...
CLASS_LOADER_REGISTER_CLASS(custon_robot_msgs_msg_msgsRequest_common, MATLABROSMsgInterface<custon_robot_msgs::msgsRequest>)
CLASS_LOADER_REGISTER_CLASS(custon_robot_msgs_msg_msgsResponse_common, MATLABROSMsgInterface<custon_robot_msgs::msgsResponse>)
CLASS_LOADER_REGISTER_CLASS(custon_robot_msgs_msgs_service, ROSMsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
