...
% % apexData就是师兄要的画图的数据
% apexData = ProcessApex(table,robotBodyData);
% % traceData就是画轨迹用的数据
% traceData = ProcessTrace(table,robotBodyData);
% % gapData就是障碍物的数据
% gapData = ProcessGap(gap); 
% 
% save('apexData','apexData');
% save('traceData','traceData');
% save('gapData','gapData');
