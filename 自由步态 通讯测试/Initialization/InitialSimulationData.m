function BODY_FOR_CALU=InitialSimulationData(BODY_FOR_CALU,BODY_PARA, Gap, target)
...
%    [XS YS WS_down WS_up] = WSC(k,BODY_FOR_CALU.TBG*BODY_FOR_CALU.TCB(:,:,k),BODY_PARA,BODY_FOR_CALU.TBG*BODY_FOR_CALU.TCB(:,:,k)*[435,-25,-520,1].');
...
axis([-800,3000,-1200,1200,0,1000]); 
