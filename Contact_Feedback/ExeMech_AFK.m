...
p2x=124/1000;     p2y=25.631/1000;     p2z=28.0985/1000;
p3x=124/1000;     p3y=25.631/1000;     p3z=28.0985/1000;   
l1x=5.362/1000;
...
w_foot = zeros(3,1000);
v_foot = zeros(3,1000);
aw_foot = zeros(3,1000);
av_foot = zeros(3,1000);
q_a = [-0.1 -0.2 -0.3 0 0 0]';
for i = 1 : 1000
    xF = footx(i,2);
    yF = footy(i,2);
    zF = footz(i,2); 
    ...
    %% 加速度正解
    [w_foot(:,i), v_foot(:,i), aw_foot(:,i), av_foot(:,i)] = walkLegExeMechAFK...
...
subplot(3,1,1)
plot(t,aw_foot(1,:))
title('\alpha_{\omega_x}')
subplot(3,1,2)
plot(t,aw_foot(2,:))
title('\alpha_{\omega_y}')
subplot(3,1,3)
plot(t,aw_foot(3,:))
title('\alpha_{\omega_z}')
