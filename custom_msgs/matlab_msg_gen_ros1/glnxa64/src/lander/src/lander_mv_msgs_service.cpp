...
// Common copy functions for lander/mv_msgsRequest
...
class LANDER_EXPORT lander_msg_mv_msgsRequest_common : public MATLABROSMsgInterface<lander::mv_msgs::Request> {
  public:
    virtual ~lander_msg_mv_msgsRequest_common(){}
    virtual void copy_from_struct(lander::mv_msgs::Request* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const lander::mv_msgs::Request* msg, MultiLibLoader loader, size_t size = 1);
};
  void lander_msg_mv_msgsRequest_common::copy_from_struct(lander::mv_msgs::Request* msg, const matlab::data::Struct& arr,
  ...
  MDArray_T lander_msg_mv_msgsRequest_common::get_arr(MDFactory_T& factory, const lander::mv_msgs::Request* msg,
    ...
    outArray[ctr]["Foot1TraceX"] = factory.createArray<lander::mv_msgs::Request::_foot1_trace_x_type::const_iterator, double>({currentElement_foot1_trace_x.size(),1}, currentElement_foot1_trace_x.begin(), currentElement_foot1_trace_x.end());
    // foot1_trace_y
    auto currentElement_foot1_trace_y = (msg + ctr)->foot1_trace_y;
    outArray[ctr]["Foot1TraceY"] = factory.createArray<lander::mv_msgs::Request::_foot1_trace_y_type::const_iterator, double>({currentElement_foot1_trace_y.size(),1}, currentElement_foot1_trace_y.begin(), currentElement_foot1_trace_y.end());
    // foot1_trace_z
    auto currentElement_foot1_trace_z = (msg + ctr)->foot1_trace_z;
    outArray[ctr]["Foot1TraceZ"] = factory.createArray<lander::mv_msgs::Request::_foot1_trace_z_type::const_iterator, double>({currentElement_foot1_trace_z.size(),1}, currentElement_foot1_trace_z.begin(), currentElement_foot1_trace_z.end());
    // foot2_trace_x
    auto currentElement_foot2_trace_x = (msg + ctr)->foot2_trace_x;
    outArray[ctr]["Foot2TraceX"] = factory.createArray<lander::mv_msgs::Request::_foot2_trace_x_type::const_iterator, double>({currentElement_foot2_trace_x.size(),1}, currentElement_foot2_trace_x.begin(), currentElement_foot2_trace_x.end());
    // foot2_trace_y
    auto currentElement_foot2_trace_y = (msg + ctr)->foot2_trace_y;
    outArray[ctr]["Foot2TraceY"] = factory.createArray<lander::mv_msgs::Request::_foot2_trace_y_type::const_iterator, double>({currentElement_foot2_trace_y.size(),1}, currentElement_foot2_trace_y.begin(), currentElement_foot2_trace_y.end());
    // foot2_trace_z
    auto currentElement_foot2_trace_z = (msg + ctr)->foot2_trace_z;
    outArray[ctr]["Foot2TraceZ"] = factory.createArray<lander::mv_msgs::Request::_foot2_trace_z_type::const_iterator, double>({currentElement_foot2_trace_z.size(),1}, currentElement_foot2_trace_z.begin(), currentElement_foot2_trace_z.end());
    // foot3_trace_x
    auto currentElement_foot3_trace_x = (msg + ctr)->foot3_trace_x;
    outArray[ctr]["Foot3TraceX"] = factory.createArray<lander::mv_msgs::Request::_foot3_trace_x_type::const_iterator, double>({currentElement_foot3_trace_x.size(),1}, currentElement_foot3_trace_x.begin(), currentElement_foot3_trace_x.end());
    // foot3_trace_y
    auto currentElement_foot3_trace_y = (msg + ctr)->foot3_trace_y;
    outArray[ctr]["Foot3TraceY"] = factory.createArray<lander::mv_msgs::Request::_foot3_trace_y_type::const_iterator, double>({currentElement_foot3_trace_y.size(),1}, currentElement_foot3_trace_y.begin(), currentElement_foot3_trace_y.end());
    // foot3_trace_z
    auto currentElement_foot3_trace_z = (msg + ctr)->foot3_trace_z;
    outArray[ctr]["Foot3TraceZ"] = factory.createArray<lander::mv_msgs::Request::_foot3_trace_z_type::const_iterator, double>({currentElement_foot3_trace_z.size(),1}, currentElement_foot3_trace_z.begin(), currentElement_foot3_trace_z.end());
    // foot4_trace_x
    auto currentElement_foot4_trace_x = (msg + ctr)->foot4_trace_x;
    outArray[ctr]["Foot4TraceX"] = factory.createArray<lander::mv_msgs::Request::_foot4_trace_x_type::const_iterator, double>({currentElement_foot4_trace_x.size(),1}, currentElement_foot4_trace_x.begin(), currentElement_foot4_trace_x.end());
    // foot4_trace_y
    auto currentElement_foot4_trace_y = (msg + ctr)->foot4_trace_y;
    outArray[ctr]["Foot4TraceY"] = factory.createArray<lander::mv_msgs::Request::_foot4_trace_y_type::const_iterator, double>({currentElement_foot4_trace_y.size(),1}, currentElement_foot4_trace_y.begin(), currentElement_foot4_trace_y.end());
    // foot4_trace_z
    auto currentElement_foot4_trace_z = (msg + ctr)->foot4_trace_z;
    outArray[ctr]["Foot4TraceZ"] = factory.createArray<lander::mv_msgs::Request::_foot4_trace_z_type::const_iterator, double>({currentElement_foot4_trace_z.size(),1}, currentElement_foot4_trace_z.begin(), currentElement_foot4_trace_z.end());
    }
    return std::move(outArray);
  }
class LANDER_EXPORT lander_msg_mv_msgsResponse_common : public MATLABROSMsgInterface<lander::mv_msgs::Response> {
  public:
    virtual ~lander_msg_mv_msgsResponse_common(){}
    virtual void copy_from_struct(lander::mv_msgs::Response* msg, const matlab::data::Struct& arr, MultiLibLoader loader); 
    //----------------------------------------------------------------------------
    virtual MDArray_T get_arr(MDFactory_T& factory, const lander::mv_msgs::Response* msg, MultiLibLoader loader, size_t size = 1);
};
  void lander_msg_mv_msgsResponse_common::copy_from_struct(lander::mv_msgs::Response* msg, const matlab::data::Struct& arr,
               MultiLibLoader loader) {
    try {
        //isFinish
...
class LANDER_EXPORT lander_mv_msgs_service : public ROSMsgElementInterfaceFactory {
  public:
    virtual ~lander_mv_msgs_service(){}
  ...
  std::shared_ptr<MATLABPublisherInterface> 
          lander_mv_msgs_service::generatePublisherInterface(ElementType type){
    std::shared_ptr<MATLABPublisherInterface> ptr;
    if(type == eRequest){
        ptr = std::make_shared<ROSPublisherImpl<lander::mv_msgs::Request,lander_msg_mv_msgsRequest_common>>();
    }else if(type == eResponse){
        ptr = std::make_shared<ROSPublisherImpl<lander::mv_msgs::Response,lander_msg_mv_msgsResponse_common>>();
    }else{
  ...
  std::shared_ptr<MATLABSubscriberInterface> 
          lander_mv_msgs_service::generateSubscriberInterface(ElementType type){
    std::shared_ptr<MATLABSubscriberInterface> ptr;
    if(type == eRequest){
        ptr = std::make_shared<ROSSubscriberImpl<lander::mv_msgs::Request,lander::mv_msgs::Request::ConstPtr,lander_msg_mv_msgsRequest_common>>();
    }else if(type == eResponse){
        ptr = std::make_shared<ROSSubscriberImpl<lander::mv_msgs::Response,lander::mv_msgs::Response::ConstPtr,lander_msg_mv_msgsResponse_common>>();
    }else{
        throw std::invalid_argument("Wrong input, Expected 'Request' or 'Response'");
    }
    return ptr;
  ...
  std::shared_ptr<MATLABSvcServerInterface> 
          lander_mv_msgs_service::generateSvcServerInterface(){
    return std::make_shared<ROSSvcServerImpl<lander::mv_msgs::Request,lander::mv_msgs::Response,lander_msg_mv_msgsRequest_common,lander_msg_mv_msgsResponse_common>>();
  }
  std::shared_ptr<MATLABSvcClientInterface> 
          lander_mv_msgs_service::generateSvcClientInterface(){
    return std::make_shared<ROSSvcClientImpl<lander::mv_msgs,lander::mv_msgs::Request,lander::mv_msgs::Response,lander_msg_mv_msgsRequest_common,lander_msg_mv_msgsResponse_common>>();
  }
#include "ROSbagTemplates.hpp" 
  std::shared_ptr<MATLABRosbagWriterInterface> 
          lander_mv_msgs_service::generateRosbagWriterInterface(ElementType type){
    std::shared_ptr<MATLABRosbagWriterInterface> ptr;
    if(type == eRequest){
        ptr = std::make_shared<ROSBagWriterImpl<lander::mv_msgsRequest,lander_msg_mv_msgsRequest_common>>();
    }else if(type == eResponse){
        ptr = std::make_shared<ROSBagWriterImpl<lander::mv_msgsResponse,lander_msg_mv_msgsResponse_common>>();
    }else{
        throw std::invalid_argument("Wrong input, Expected 'Request' or 'Response'");
    }
    return ptr;
...
CLASS_LOADER_REGISTER_CLASS(lander_msg_mv_msgsRequest_common, MATLABROSMsgInterface<lander::mv_msgsRequest>)
CLASS_LOADER_REGISTER_CLASS(lander_msg_mv_msgsResponse_common, MATLABROSMsgInterface<lander::mv_msgsResponse>)
CLASS_LOADER_REGISTER_CLASS(lander_mv_msgs_service, ROSMsgElementInterfaceFactory)
#ifdef _MSC_VER
#pragma warning(pop)
#else
