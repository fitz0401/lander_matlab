...
classdef mv_msgsRequest < ros.Message
    %mv_msgsRequest MATLAB implementation of lander/mv_msgsRequest
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.lander.mv_msgsRequest.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.lander.mv_msgsRequest(strObj);
        end
    end
end
