// Generated by gencpp from file lander/gait_plan_msgs.msg
// DO NOT EDIT!


#ifndef LANDER_MESSAGE_GAIT_PLAN_MSGS_H
#define LANDER_MESSAGE_GAIT_PLAN_MSGS_H
...
struct gait_plan_msgs_
{
  typedef gait_plan_msgs_<ContainerAllocator> Type;
  ...
  gait_plan_msgs_(const ContainerAllocator& _alloc)
    : command_index(0)
    , leg_index(0)
    , foot1_motion()
    , foot2_motion()
  ...
  typedef boost::shared_ptr< ::lander::gait_plan_msgs_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::lander::gait_plan_msgs_<ContainerAllocator> const> ConstPtr;

}; // struct gait_plan_msgs_

typedef ::lander::gait_plan_msgs_<std::allocator<void> > gait_plan_msgs;

typedef boost::shared_ptr< ::lander::gait_plan_msgs > gait_plan_msgsPtr;
typedef boost::shared_ptr< ::lander::gait_plan_msgs const> gait_plan_msgsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::lander::gait_plan_msgs_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::lander::gait_plan_msgs_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::lander::gait_plan_msgs_<ContainerAllocator1> & lhs, const ::lander::gait_plan_msgs_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::lander::gait_plan_msgs_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::lander::gait_plan_msgs_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::lander::gait_plan_msgs_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::lander::gait_plan_msgs_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lander::gait_plan_msgs_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lander::gait_plan_msgs_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::lander::gait_plan_msgs_<ContainerAllocator> >
{
  ...
  static const char* value(const ::lander::gait_plan_msgs_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb401d108fe4e07f9ULL;
  static const uint64_t static_value2 = 0x12067db7a9916b5eULL;
};

template<class ContainerAllocator>
struct DataType< ::lander::gait_plan_msgs_<ContainerAllocator> >
{
  static const char* value()
  {
    return "lander/gait_plan_msgs";
  }
...
template<class ContainerAllocator>
struct Definition< ::lander::gait_plan_msgs_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# 客户端请求\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::lander::gait_plan_msgs_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::lander::gait_plan_msgs_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::lander::gait_plan_msgs_<ContainerAllocator>& v)
  {
...
#endif // LANDER_MESSAGE_GAIT_PLAN_MSGS_H
