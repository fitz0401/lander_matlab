...
"""autogenerated by genpy from lander/gait_feedback_msgsRequest.msg. Do not edit."""
import codecs
import sys
...
class gait_feedback_msgsRequest(genpy.Message):
  _md5sum = "b401d108fe4e07f912067db7a9916b5e"
  _type = "lander/gait_feedback_msgsRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(gait_feedback_msgsRequest, self).__init__(*args, **kwds)
...
def _get_struct_i():
    ...
    return _struct_i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from lander/gait_feedback_msgsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class gait_feedback_msgsResponse(genpy.Message):
  _md5sum = "532b0c4ac83e2427806e5be0d649382c"
  _type = "lander/gait_feedback_msgsResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(gait_feedback_msgsResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_B():
    ...
    return _struct_B
class gait_feedback_msgs(object):
  _type          = 'lander/gait_feedback_msgs'
  _md5sum = '27d686c76786081478a2ea2d859bdf1f'
  _request_class  = gait_feedback_msgsRequest
  _response_class = gait_feedback_msgsResponse
