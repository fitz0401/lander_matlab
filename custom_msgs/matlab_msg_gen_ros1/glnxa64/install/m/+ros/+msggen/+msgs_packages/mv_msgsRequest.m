...
classdef mv_msgsRequest < ros.Message
    %mv_msgsRequest MATLAB implementation of msgs_packages/mv_msgsRequest
    %   This class was automatically generated by
    %   ros.internal.pubsubEmitter.
    %   Copyright 2014-2020 The MathWorks, Inc.
    properties (Constant)
        MessageType = 'msgs_packages/mv_msgsRequest' % The ROS message type
    end
    ...
    methods
        ...
        function set.DataNum(obj, val)
            validClasses = {'numeric'};
            validAttributes = {'nonempty', 'scalar'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'DataNum');
        ...
        function set.Foot1TraceX(obj, val)
            ...
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot1TraceX');
        ...
        function set.Foot1TraceY(obj, val)
            ...
            val = val(:);
            validAttributes = {'vector'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot1TraceY');
        ...
        function set.Foot1TraceZ(obj, val)
            ...
            val = val(:);
            validAttributes = {'vector'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot1TraceZ');
        ...
        function set.Foot2TraceX(obj, val)
            ...
            val = val(:);
            validAttributes = {'vector'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot2TraceX');
        ...
        function set.Foot2TraceY(obj, val)
            ...
            val = val(:);
            validAttributes = {'vector'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot2TraceY');
        ...
        function set.Foot2TraceZ(obj, val)
            ...
            val = val(:);
            validAttributes = {'vector'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot2TraceZ');
        ...
        function set.Foot3TraceX(obj, val)
            ...
            val = val(:);
            validAttributes = {'vector'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot3TraceX');
        ...
        function set.Foot3TraceY(obj, val)
            ...
            val = val(:);
            validAttributes = {'vector'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot3TraceY');
        ...
        function set.Foot3TraceZ(obj, val)
            ...
            val = val(:);
            validAttributes = {'vector'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot3TraceZ');
        ...
        function set.Foot4TraceX(obj, val)
            ...
            val = val(:);
            validAttributes = {'vector'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot4TraceX');
        ...
        function set.Foot4TraceY(obj, val)
            ...
            val = val(:);
            validAttributes = {'vector'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot4TraceY');
        ...
        function set.Foot4TraceZ(obj, val)
            ...
            val = val(:);
            validAttributes = {'vector'};
            validateattributes(val, validClasses, validAttributes, 'mv_msgsRequest', 'Foot4TraceZ');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?ros.Message})
        ...
        % Return an empty object array if the structure element is not defined
            if isempty(strObj)
                obj = ros.msggen.msgs_packages.mv_msgsRequest.empty(0,1);
                return
            end
            % Create an empty message object
            obj = ros.msggen.msgs_packages.mv_msgsRequest(strObj);
        end
    end
end
